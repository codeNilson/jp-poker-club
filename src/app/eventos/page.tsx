  ...
  return (
    <section className="relative isolate overflow-hidden px-4 pb-16 sm:px-6 lg:px-8 animate-in fade-in-0 duration-500">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute -left-20 top-2/3 h-56 w-56 rounded-full bg-emerald-500/10 blur-3xl" />
      </div>
      ...
      <div className="mx-auto w-full max-w-4xl">
        <article className="rounded-3xl border border-border/80 bg-card/70 p-5 text-center backdrop-blur sm:p-8">
          ...
          <h1 className="mt-5 text-2xl font-black tracking-tight sm:text-4xl">Página de eventos em construção</h1>
          <p className="mx-auto mt-3 max-w-2xl text-sm text-muted-foreground sm:text-base">
            Estamos preparando uma experiência completa para você acompanhar torneios, cash games e agenda do clube.
          </p>
          ...
          <div className="mt-6 rounded-2xl border border-border/70 bg-muted/30 p-4 text-left sm:p-5">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Lista de próximos eventos, filtros por tipo, status em tempo real e detalhes de cada rodada.
            </p>
          </div>
