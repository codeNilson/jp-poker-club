...
from (
  values
    ...
    ('22222222-2222-4222-8222-222222222232', 'Promoção de Recarga da Carteira', 'Aproveite os creditos extras para assinantes nas recargas via PIX.', 'https://placehold.co/1200x630/101418/32E035?text=Promoção+Carteira', 'https://placehold.co/800x1000/101418/32E035?text=Promoção+Carteira', 'Conferir promoção', '/promocoes', true, 2),
...
from (
  values
    ('11111111-1111-4111-8111-111111111121', 'Ranking de abril ganhou novo topo da tabela', 'A disputa ficou mais apertada nas primeiras rodadas.', 'O ranking de abril foi atualizado com destaque para os jogadores que mais pontuaram na ultima semana.', 'ranking-de-abril-ganhou-novo-topo-da-tabela', 'ranking', 'noticias/img1', 4, true, true, true, now() - interval '1 day'),
    ('22222222-2222-4222-8222-222222222223', 'Agenda oficial de torneios foi revisada', 'Datas e limites ficaram mais claros para os proximos eventos.', 'A agenda publica agora mostra os proximos encontros com mais clareza e melhor separacao por formato.', 'agenda-oficial-de-torneios-foi-revisada', 'eventos', 'noticias/img2', 3, false, false, true, now() - interval '2 days'),
    ('33333333-3333-4333-8333-333333333334', 'Bonus de 20 por cento para assinantes segue ativo', 'O credito adicional continua valendo para depositos confirmados.', 'O beneficio de assinatura continua sendo aplicado automaticamente no momento da confirmacao do deposito.', 'bonus-de-20-por-cento-para-assinantes-segue-ativo', 'assinatura', 'noticias/poker-1', 5, false, false, true, now() - interval '3 days'),
    ('44444444-4444-4444-8444-444444444445', 'Regras do buy-in presencial seguem em validacao', 'A equipe ainda fecha o fluxo final antes de publicar a regra definitiva.', 'O processo presencial segue em revisao interna para que a operacao fique simples e segura para o clube.', 'regras-do-buy-in-presencial-seguem-em-validacao', 'comunicado', 'noticias/poker-5', 2, false, false, true, now() - interval '4 days'),
    ('55555555-5555-4555-8555-555555555556', 'Bastidores do clube mostram semana movimentada', 'Mesa cheia, agenda intensa e mais procura por eventos.', 'O movimento da semana mostrou um clube mais ativo, com varios jogadores voltando para o calendario presencial.', 'bastidores-do-clube-mostram-semana-movimentada', 'clube', 'noticias/maos-de-poker', 4, false, true, true, now() - interval '5 days'),
