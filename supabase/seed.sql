...
from (
  values
    ...
    ('33333333-3333-4333-8333-333333333334', 'Bonus de 20 por cento para assinantes segue ativo', 'O credito adicional continua valendo para depositos confirmados.', 'O beneficio de assinatura continua sendo aplicado automaticamente no momento da confirmacao do deposito.', 'bonus-de-20-por-cento-para-assinantes-segue-ativo', 'assinatura', null, 5, true, false, true, now() - interval '3 days'),
