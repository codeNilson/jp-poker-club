...
from (
  values
    ...
    ('66666666-6666-4666-8666-666666666667', 'Promoção de recarga ganhou nova janela', 'A campanha de credito voltou com periodo limitado.', 'A recarga promocional agora conta com uma nova janela de participacao para assinantes e convidados.', 'promoção-de-recarga-ganhou-nova-janela', 'promoção', null, 3, false, true, true, now() - interval '6 days'),
